...
public class SrxMotionProfileFollower {
	...
	//added these privates to use later down there ~BOB
			...
			switch (_state) {
				...
				case 2: /* check the status of the MP */
					...
					if (_status.activePointValid && _status.activePoint.isLastPoint) {
						...
						_state = 0;
						_loopTimeout = -1;
						_bFin = true;//add this to make the command finish-Joshua 1/29/17
					}
					break;
			}
		}
	...
	private void startFilling() {
		...
		startFilling(_mp.points, _mp.numPoints);
	}
	...
	//changed to public void instead of void ~BOB
	...
	public CANTalon.SetValueMotionProfile getSetValue() {
		return _setValue;
		//made it public so it can be seen in command
	}
}
